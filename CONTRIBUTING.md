...
First things first, please review the ta11y Project's [Code of Conduct](https://github.com/hyperledger/hyperledger/wiki/Hyperledger-Project-Code-of-Conduct) before participating. It is important that we keep things civil. \[TODO] create/derive code of conduct

### Getting help
If you are looking for something to work on, or need some expert assistance in debugging a problem or working out a fix to an issue, our community is always eager to help. We hang out on [Slack](https://ta11y.slack.com/), IRC (#ta11y on freenode.net) and the [mailing lists](http://example.com/). \[TODO] create mailing list
